...
RUN    apt-get --yes update; \
       ...
       apt-get --yes install jq curl oracle-java8-installer libvips gettext-base nmap locales monit python3-pip libffi-dev sudo wget software-properties-common libxft-dev libfreetype6-dev tmux man git build-essential vim htop; \
       apt-get clean
