...
startdate = 201508140000
stopdate = 201510020000
coords = ("-276", "128", "8431")
distance = 90
initialangle = 45
...
snapshotsinitialunchecked = [snap for snap in sorted(glob.glob("/minecraft/worlddisk*/.zfs/snapshot/2015????00??"), key=customsorter) if int(customsorter(snap)) >= startdate and int(customsorter(snap)) <= stopdate]
...
#snapshotsinitial = snapshotsinitial[106]
...
for snap in list(snapshotenum)[0:1]:
