...
def genEvent(line):
    parseDict = OrderedDict([("deathFloorLava", "^\[(.*)\] \[Server thread/INFO\]: (.*) (discovered floor was lava)$"),
                                ...
                                ("joined", "^\[(.*)\] \[Server thread/INFO\]: (\w*) joined the game$"),
                                ...
                                ("chat", "^\[(.*)\] \[Server thread/INFO\]: \<(\w*)\> (.*)$"),
                                ("serverchat", "^\[(.*)\] \[Server thread/INFO\]: \[Server\] (.*)$"),
                                ("playerList", "^\[(.*)\] \[Server thread/INFO\]: There are (.*)/(.*) players online:$"),
                                ("UUID", "^\[(.*)\] \[User Authenticator#.*/INFO\]: UUID of player (\w*) is (.*)$"),
                                ("whitelistAdd", "^\[(.*)\] \[Server thread/INFO\]: Added (\w*) to the whitelist"),
                                ("whitelistRemove", "^\[(.*)\] \[Server thread/INFO\]: Removed (\w*) from the whitelist"),
